...
class MyAppState extends ChangeNotifier {
  ...
  void incrementCounter() {
    counter++;
    ///Joue le role de setState : notifie le widget ChangeNotifierProvider
    ///(qui est un wrapper d'un InheritedWidget). Déclenche le rebuild de tout son subtree.
    notifyListeners();
  }
}
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '${Provider.of<MyAppState>(context).counter}',
